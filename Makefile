...
# AWS ECR settings
DOCKER_REGISTRY ?= 266692567846.dkr.ecr.eu-west-1.amazonaws.com
# AWS_ACCOUNT_ID ?= 266692567846
DOCKER_LOGIN_EXPRESSION := eval $$(aws ecr get-login --no-include-email --region eu-west-1)
